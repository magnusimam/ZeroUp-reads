...
- `mockData.js` (`MOCK_USER.readingGoal`, `dayStreak`) — goal/streak values are still static mock fields, not computed by any rule. Out of scope for this pass (no rule exists yet to compute them from).
